...
const StudentDashboardPage = () => {
  ...
  return (
    <div className="min-h-[calc(100vh-4rem)] bg-slate-950/95 px-4 py-8 sm:px-6 lg:px-10">
      <div className="mx-auto flex max-w-6xl gap-6 md:grid md:grid-cols-[260px,1fr]">
      ...
      <section className="flex-1 rounded-3xl border border-slate-800 bg-slate-900/80 p-6 sm:p-7 lg:p-8 h-[540px] sm:h-[580px] lg:h-[620px] flex flex-col overflow-hidden">
        {loadingData ? (
                ...
                {continueLearningCourses.length === 0 ? (
                  ...
                  <div className="space-y-3">
                    {continueLearningCourses.map((course) => (
                      <div
                        key={course._id}
                        className="flex items-center justify-between rounded-2xl border border-slate-800 bg-slate-900/90 px-5 py-4 text-sm"
                      >
                        <div>
                        ...
                        <button
                          ...
                          className="rounded-full bg-blue-500 px-4 py-2 text-xs sm:text-sm font-semibold text-slate-950 shadow-md transition hover:bg-blue-400"
                        >
                          Resume
                        </button>
                      </div>
                ...
                {orders.length === 0 ? (
                  ...
                  <div className="space-y-3 text-sm">
                    {orders.map((order) => (
                      <div
                        key={order._id}
                        className="flex items-center justify-between rounded-2xl border border-slate-800 bg-slate-900/90 px-5 py-4"
                      >
                        <div>
